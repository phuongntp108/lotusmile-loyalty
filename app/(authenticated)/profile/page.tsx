...
export default function Profile() {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async (
      data: Record<string, string> | BodyInit | null | undefined
    ) => {
        ...
        <div className="lg:col-span-1">
          <Card className="p-6 text-center" data-testid="card-user-info">
            ...
            <div className="mb-4">
              <Button
                variant="outline"
                className="text-airline-blue hover:text-blue-700 text-sm font-medium"
            ...
            <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-airline-gold text-white mb-4">
              ...
              <span data-testid="text-membership-tier">
