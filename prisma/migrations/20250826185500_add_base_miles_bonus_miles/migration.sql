...
INSERT INTO "new_Request" ("createdAt", "flightCode", "from", "id", "miles", "requestorId", "status", "to", "type") SELECT "createdAt", "flightCode", "from", "id", "miles", "requestorId", "status", "to", "type" FROM "Request";
DROP TABLE "Request";
